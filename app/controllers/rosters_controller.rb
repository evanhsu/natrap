class RostersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @roster.save
        format.html { redirect_to(roster_for_admin_crew_url(@crew.id, @roster.year), :notice => 'Roster was successfully created.') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(admin_crew_url(@crew_id)) }
      format.xml  { head :ok }
    end
  end
end
